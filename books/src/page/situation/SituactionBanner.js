...
class SituactionBanner extends Component{
    render(){
        return(
            <div className="Situation_banner">
                <Carousel
                    ...
                    dots={false}
                >
                    <div><div className="_banner_bj"><img src={require('../../images/situation_banner.png')} alt=""/></div></div>
                    <div><div className="_banner_bj"><img src={require('../../images/situation_banner.png')} alt=""/></div></div>
                    <div><div className="_banner_bj"><img src={require('../../images/situation_banner.png')} alt=""/></div></div>
                    <div><div className="_banner_bj"><img src={require('../../images/situation_banner.png')} alt=""/></div></div>
                </Carousel>
...
export default SituactionBanner